...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: "100vh", display: "flex", background: BG }}>
      ...
      {frozenPopup && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ width: 56, height: 56, borderRadius: "50%", border: "1px solid rgba(239,68,68,0.3)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 20px" }}>
      ...
      {/* ── Application Under Review Popup ── */}
      {pendingPopup && (
        <div style={{
          position: "fixed", inset: 0, zIndex: 999, display: "flex", alignItems: "center", justifyContent: "center",
          background: "rgba(0,0,0,0.8)", backdropFilter: "blur(8px)",
          ...
          <div style={{
            ...
            <p style={{ fontSize: 13, color: "rgba(255,255,255,0.4)", lineHeight: 1.7, margin: "0 0 28px" }}>
              Your application has been submitted and is currently being reviewed by our compliance team. You'll receive an email once a decision has been made — this typically takes 24–48 business hours.
            </p>
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              <a href="https://wa.me/18886555555?text=I%20submitted%20my%20application%20and%20want%20to%20check%20its%20status." target="_blank" rel="noopener noreferrer" style={{
                display: "flex", alignItems: "center", justifyContent: "center", gap: 10, width: "100%",
                padding: "14px", borderRadius: 12, background: "#25D366", color: "#fff",
                textDecoration: "none", fontSize: 13, fontWeight: 700, letterSpacing: "0.04em",
              ...
              <button onClick={() => setPendingPopup(false)} style={{
                width: "100%", padding: "12px", borderRadius: 12, background: "transparent",
                border: "1px solid rgba(255,255,255,0.08)", color: "rgba(255,255,255,0.35)",
                fontSize: 12, fontWeight: 600, cursor: "pointer",
              }}>
